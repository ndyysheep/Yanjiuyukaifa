var FormEditable = function () {
    ...
    var initEditables = function () {
        ...
        $('#record_view #DeviceId').editable({
            url: ' ../../device_file_servlet_action?action=edit_record',
            type: 'text',
            pk:''+getUrlParam("id")+''
        });

        $('#record_view #Speed').editable({
            url: ' ../../device_file_servlet_action?action=edit_record',
            type: 'text',
            pk:''+getUrlParam("id")+''
        });

        $('#record_view #Direction').editable({
            url: ' ../../device_file_servlet_action?action=edit_record',
            type: 'text',
            pk:''+getUrlParam("id")+''
        });

        $('#record_view #Latitude').editable({
            url: ' ../../device_file_servlet_action?action=edit_record',
            type: 'text',
            pk:''+getUrlParam("id")+''
        });

        $('#record_view #Longitude').editable({
            url: ' ../../device_file_servlet_action?action=edit_record',
            type: 'text',
            pk:''+getUrlParam("id")+''
        });

        $('#record_view #Location').editable({
            url: ' ../../device_file_servlet_action?action=edit_record',
            type: 'text',
            pk:''+getUrlParam("id")+''
        });
