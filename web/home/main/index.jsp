...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
                我的数据库表<small>basic datatable samples</small>
            </h3>
            <!-- END PAGE HEADER-->
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat blue-madison">
                        ...
                        <div class="details">
                            <div class="number" id="gps_vehicle_number">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat red-intense">
                        ...
                        <a class="more" id="for_device_list">
                            View more <i class="m-icon-swapright m-icon-white"></i>
                        </a>
                    </div>
                </div>
    ...
    var Page = function(){
        var initPageControl=function(){
            ...
            if(pageId=="dash_board"){
                $("#for_device_list").click(function(){
                    window.location.href="../../maintain/device/monitor_list.jsp";
                });
                initDeviceList();
            }
        ...
        var initDeviceList = function(){
            {
                var data={};
                data.action ="get_GPS_record";
                $.post("../../device_file_servlet_action",data,function(json){
                    console.log(JSON.stringify(json));
                    if(json.result_code==0){
                        var record=json.gps_vehicle_number;
                        $("#gps_vehicle_number").html(record);
                    }
                })
            }
        }
