...
<div class="modal fade draggable-modal" id="todo_modify_div" name="todo_modify_div" tabindex="-1" role="basic" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
      ...
      <div class="modal-body">
        <div class="portlet-body form">
          <form id="modify_form" class="form-horizontal" role="form" >
            <input type="hidden" id="tid" name="tid" value="">
            <div class="form-body">
              <div class="form-group">
                <label class="col-md-3 control-label">user name</label>
                <div class="col-md-9">
                  <input type="text" class="form-control" placeholder="Enter text" name="user_name" id="user_name">
            ...
            <div class="form-body">
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <input type="text" class="form-control" placeholder="Enter text" name="nickname" id="nickname">
                  <span class="help-block">
											输入</span>
                </div>
              </div>
            ...
            <div class="form-body">
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <input type="text" class="form-control" placeholder="Enter text" name="todo" id="todo">
                  <span class="help-block">
											输入</span>
                </div>
              </div>
            ...
            <div class="form-body">
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <input type="text" class="form-control" placeholder="Enter text" name="todo_time" id="todo_time">
                  <span class="help-block">
											输入</span>
                </div>
              </div>
            ...
            <div class="form-body">
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <input type="text" class="form-control" placeholder="Enter text" name="todo_notes" id="todo_notes">
                  <span class="help-block">
											输入 </span>
                </div>
              </div>
...
<div class="modal fade draggable-modal" id="add_modify_div" name="add_modify_div" tabindex="-1" role="basic" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title">添加待办事项信息</h4>
      </div>
      <div class="modal-body">
        <div class="portlet-body form">
          <form id="add_form" class="form-horizontal" role="form" >r
            <input type="hidden" id="tid_add" name="u=tid" value="">
            <div class="form-body">
              <div class="form-group">
                <label class="col-md-3 control-label">user name</label>
                <div class="col-md-9">
            ...
            <div class="form-body">
              <div class="form-group">
                <label class="col-md-3 control-label">todo</label>
                <div class="col-md-9">
                  <input type="text" class="form-control" placeholder="Enter text" name="todo">
                  <span class="help-block">
											输入</span>
                </div>
              </div>
            ...
            <div class="form-body">
              <div class="form-group">
                <label class="col-md-3 control-label">deadline</label>
                <div class="col-md-9">
                  <input type="text" class="form-control" placeholder="Enter text" name="todo_time">
                  <span class="help-block">
											输入</span>
                </div>
              </div>
            ...
            <div class="form-body">
              <div class="form-group">
                <label class="col-md-3 control-label">notes</label>
                <div class="col-md-9">
                  <input type="text" class="form-control" placeholder="Enter text" name="todo_notes">
                  <span class="help-block">
											输入 </span>
                </div>
              </div>
...
<div class="modal fade draggable-modal" id="search_div" name="search_div" tabindex="-1" role="basic" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title">查询待办事项信息</h4>
      </div>
      <div class="modal-body">
        <div class="portlet-body form">
