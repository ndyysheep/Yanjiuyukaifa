        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="../monitor/monitor_list.jsp">违法数据监控</a>
                    </li>
                </ul>
            </div>
            <!-- END PAGE BREADCRUMB -->
            <!-- END PAGE HEADER-->
            <!-- BEGIN PAGE CONTENT-->
            <input type="hidden" id="page_id" name="page_id" value="illegal_view">
            <div class="portlet light">
                <div class="portlet-body" id="illegal_record_view_div">
                    <div class="row">
                        <div class="col-md-12">
...
<script src="containers/js/illegal.view.js" type="text/javascript"></script>
<script>
