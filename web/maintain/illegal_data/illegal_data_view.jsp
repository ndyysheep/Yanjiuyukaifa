...
<div class="page-container">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active">
                            <a href="form_editable.html">
                                <span class="badge badge-roundless badge-warning" class=""></span>详情页</a>
                        </li>
                        <li>
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <input type="hidden" id="page_id" name="page_id" value="illegal_data_view">
            ...
            <h3 class="page-title" >
                设备详情页 <small id="my_id"></small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        <i class="fa fa-home"></i>
                        <a href="../../home/main/index.jsp">主页</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <a href="illegal_data_list.jsp">设备列表</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <a href="#">详情页</a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <button id="return_button" class="btn blue">返回上一界面</button>
                    <hr>
                </div>
            </div>
            <div class="row" id = "record_view">
                <div class="col-md-12">
                    <table id="user" class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td style="width:50%">
                                <a href="javascript:;" id="DeviceId" data-type="text"data-original-title="Enter Deviceid">
                                     </a>
                            </td>
                            <td style="width:35%">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:;" id="GPS_Time" data-type="date" data-viewformat="yyyy-mm-dd hh:mm:ss" data-placement="right" data-original-title="修改GPS时间">
                                    1970-01-01 00:00:00
                                </a>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:;" id="Recv_Time" data-type="date" data-viewformat="yyyy-mm-dd hh:mm:ss"  data-placement="right" data-original-title="修改接收时间">
                                    1970-01-01 00:00:00
                                </a>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:;" id="Longitude" data-type="text"data-original-title="输入经度">
                                    Admin </a>
                            </td>
                            <td>
							<span class="text-muted">
							记录了该设备使用GPS所在的<strong>经度</strong></span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <a href="javascript:;" id="Latitude" data-type="text"data-original-title="输入纬度">
                                    </a>
                            </td>
                            <td>
							<span class="text-muted">
							记录了该设备使用GPS所在的纬度 </span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <a href="javascript:;" id="Speed" data-type="text"data-original-title="输入速度">
                                    </a>
                            </td>
                            <td>
							<span class="text-muted">
							记录了该设备使用GPS时的速度  </span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <a href="javascript:;" id="Direction" data-type="text"data-original-title="输入方向">
                                     </a>
                            </td>
                            <td>
							<span class="text-muted">
							记录了该设备使用GPS所在的方位 </span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <a href="javascript:;" id="Location" data-type="text"data-original-title="输入位置">
                                    </a>
                            </td>
                            <td>
							<span class="text-muted">
							记录了该设备使用GPS所在的位置地点 </span>
                            </td>
                        </tr>
