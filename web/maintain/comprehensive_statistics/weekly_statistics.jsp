...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <input  type="hidden" id="page_id" name="page_id" value="weekly_report">
                ...
                <div class="col-md-12">
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-comments"></i>违法数据周报表
                            </div>
                            <div class="tools">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject bold uppercase font-green-haze">当周各路段违法情况统计图</span>
