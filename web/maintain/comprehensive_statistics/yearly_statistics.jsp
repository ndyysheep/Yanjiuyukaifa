        ...
        <div class="page-content">
            ...
            <div class="page-head">
                ...
                <div class="page-title">
                    <h1>违法结果统计分析<small>年报表</small></h1>
                </div>
                <!-- END PAGE TITLE -->
            ...
            <input  type="hidden" id="page_id" name="page_id" value="yearly_report">
                ...
                <div class="col-md-12">
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-comments"></i>违法数据年报表
                            </div>
                            <div class="tools">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject bold uppercase font-green-haze">该年份各路段违法情况统计图</span>
            ...
            <div class="portlet box red">
                <div class="portlet-title">
                    <div class="caption" id="reportTitle">
                        <i class="fa fa-gift"></i>该年各路段违法情况
                    </div>
                    <div class="tools">
                        <a href="javascript:;" class="collapse">
                        </a>
