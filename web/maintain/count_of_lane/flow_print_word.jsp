...
<input type="hidden" id="page_id" name="page_id" value="flow_print_word">
...
<div class=WordSection1 style='layout-grid:15.6pt'>
  ...
  height:28.05pt'>
                <p class=MsoNormal align=center style='text-align:center'><b><i><span
                        style='font-family:"微软雅黑",sans-serif;color:black'>车流量信息表</span></i></b></p>
            </td>
        </tr>
  ...
  background:white;padding:0cm 5.4pt 0cm 5.4pt;height:26.95pt' class="hidden-xs">
                <p class=MsoNormal  align=center style='text-align:center'><i><span
                        lang=EN-US style='font-family:"微软雅黑",sans-serif;color:black'>序号</span></i></p>
            </td>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:26.95pt'>
                <p class=MsoNormal align=center style='text-align:center'><span
                        style='font-family:"微软雅黑",sans-serif'>抓拍路段</span></p>
            </td>
            <td width=63 valign=top style='width:47.05pt;border-top:none;border-left:
  none;border-bottom:solid #C9C9C9 1.0pt;border-right:solid #C9C9C9 1.0pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:26.95pt'>
                <p class=MsoNormal align=center style='text-align:center'><span
                        style='font-family:"微软雅黑",sans-serif'>起始统计时间</span></p>
            </td>
            <td width=63 valign=top style='width:47.05pt;border-top:none;border-left:
  none;border-bottom:solid #C9C9C9 1.0pt;border-right:solid #C9C9C9 1.0pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:26.95pt'>
                <p class=MsoNormal align=center style='text-align:center'><span
                        style='font-family:"微软雅黑",sans-serif'>终止统计时间</span></p>
            </td>
            <td width=63 valign=top style='width:47.05pt;border-top:none;border-left:
  none;border-bottom:solid #C9C9C9 1.0pt;border-right:solid #C9C9C9 1.0pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:26.95pt'>
                <p class=MsoNormal align=center style='text-align:center'><span
                        style='font-family:"微软雅黑",sans-serif'>车流量</span></p>
            </td>
        </tr>
