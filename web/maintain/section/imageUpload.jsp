        ...
        <div class="page-content">
            ...
            <div class="page-head">
                ...
                <div class="page-title">
                    <h1>图片分析<small> 基于opencv的交通图像分析</small></h1>
                </div>
                <!-- END PAGE TITLE -->
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="../monitor/monitor_list.jsp">交通材料分析</a>
                        <i class="fa fa-circle"></i>
                    </li>
                    <li>
                        <a href="imageUpload.jsp">图像分析</a>
                    </li>
                </ul>
            </div>
            ...
            <%--开始当前自写板块--%>
            <input  type="hidden" id="page_id" name="page_id" value="imageUpload">
            ...
            <div class="portlet light">
                            ...
                            <form id="ajax_form" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row fileupload-buttonbar">
                                    <div class="col-lg-7">
                                        ...
                                        <button type="button" class="btn blue" id="upload_button" disabled>
                                            <i class="fa fa-upload"></i>
                                            <span>
										开始上传 </span>
                                        </button>
                                        <button type="button" class="btn warning cancel" id="cancel_button">
                ...
                <div class="row" id="hide_button_div" style="display:none">
                    <div class="col-md-12">
                        <button id="recognize_button" type="button" class="btn default blue-stripe">开始识别</button>
                    </div>
