...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
                车辆监控<small>basic datatable samples</small>
            </h3>
            <div class="page-bar">
            ...
            <div class="row">
                <div class="col-md-12">
                    <button type="button" id="ac_add_button" name ="ac_add_button" class="btn red">添加记录</button>
                    ...
                    <button type="button" id="ac_query_button" name ="query_button" class="btn red">查询</button>
                </div>
